 ...
 */
void open_reader_read_lob_size(const char *ion_text, ION_TYPE expected_type, ION_SIZE expected_lob_size, hREADER &reader) {
    ION_TYPE type;
    ION_SIZE lob_size;
...
void test_full_lob_read(const char *ion_text, ION_TYPE expected_tid, ION_SIZE expected_size, const char *expected_value) {
    hREADER reader;
...
void test_partial_lob_read(const char *ion_text, ION_TYPE expected_tid, ION_SIZE expected_size, const char *expected_value) {
    hREADER reader;
    open_reader_read_lob_size(ion_text, expected_tid, expected_size, reader);
