 ...
 */
void open_binary_reader_read_lob_size(const char *ion_text, ION_SIZE buff_size, ION_TYPE expected_type, ION_SIZE expected_lob_size, hREADER &reader) {
    ION_TYPE type;
    ION_SIZE lob_size;
...
void test_full_binary_lob_read(const char *ion_text, ION_SIZE buff_size, ION_TYPE expected_tid, ION_SIZE expected_size, const char *expected_value) {
    hREADER reader;
...
void test_partial_binary_lob_read(const char *ion_text, ION_SIZE buff_size, ION_TYPE expected_tid, ION_SIZE expected_size, const char *expected_value) {
    hREADER reader;
    open_binary_reader_read_lob_size(ion_text, buff_size, expected_tid, expected_size, reader);

    BYTE* bytes = (BYTE*)calloc(1, expected_size + 1);
    ION_SIZE bytes_read, total_bytes_read = 0;
