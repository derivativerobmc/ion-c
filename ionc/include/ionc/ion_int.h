...
#define DECIMAL_DIGIT_COUNT_FROM_BITS(bits) (((bits) == 0) ? 1 : ((ION_SIZE)(((double)(bits) / II_DEC_DIGIT_PER_BITS) + 1)))
...
typedef struct _ion_int {
    ...
    ION_SIZE    _len;          // number of digits in the _digits array (-1 if null)
...
ION_API_EXPORT iERR ion_int_highest_bit_set (ION_INT *iint, ION_SIZE *p_pos);
...
ION_API_EXPORT iERR ion_int_from_chars      (ION_INT *iint, const char *p_chars, ION_SIZE char_limit);
ION_API_EXPORT iERR ion_int_from_hex_chars  (ION_INT *iint, const char *p_chars, ION_SIZE char_limit);
ION_API_EXPORT iERR ion_int_from_binary_chars(ION_INT *iint, const char *p_chars, ION_SIZE char_limit);
ION_API_EXPORT iERR ion_int_from_bytes      (ION_INT *iint, BYTE *buf, ION_SIZE limit);
ION_API_EXPORT iERR ion_int_from_abs_bytes  (ION_INT *iint, BYTE *buf, ION_SIZE limit, BOOL is_negative);
...
ION_API_EXPORT iERR ion_int_char_length     (ION_INT *iint, ION_SIZE *p_len);
ION_API_EXPORT iERR ion_int_to_char         (ION_INT *iint, BYTE *p_str, ION_SIZE len, ION_SIZE *p_written);
ION_API_EXPORT iERR ion_int_to_string       (ION_INT *iint, hOWNER owner, iSTRING p_str);

ION_API_EXPORT iERR ion_int_byte_length     (ION_INT *iint, ION_SIZE *p_byte_length);
ION_API_EXPORT iERR ion_int_to_bytes        (ION_INT *iint, ION_SIZE starting_int_byte_offset, BYTE *buffer, ION_SIZE buffer_length, ION_SIZE *bytes_written);
ION_API_EXPORT iERR ion_int_abs_bytes_length(ION_INT *iint, ION_SIZE *p_byte_length);
ION_API_EXPORT iERR ion_int_to_abs_bytes    (ION_INT *iint, ION_SIZE starting_int_byte_offset, BYTE *buffer, ION_SIZE buffer_length, ION_SIZE *bytes_written);
...
iERR   _ion_int_to_bytes_helper(ION_INT *iint, ION_SIZE bytes_in_int, ION_SIZE starting_int_byte_offset, BOOL is_neg, BYTE *buffer, ION_SIZE buffer_length, ION_SIZE *bytes_written);
...
//iERR   _ion_int_to_abs_bytes_helper(ION_INT *iint, ION_SIZE bytes_in_int, ION_SIZE starting_int_byte_offset, BOOL is_neg, BYTE *buffer, ION_SIZE buffer_length, ION_SIZE *bytes_written);

iERR   _ion_int_to_int64_helper(ION_INT *iint, int64_t *p_int64);

iERR  _ion_int_add_digit(II_DIGIT *digits, ION_SIZE digit_count, II_DIGIT value);
iERR  _ion_int_sub_digit(II_DIGIT *digits, ION_SIZE digit_count, II_DIGIT value);
/* not used
iERR  _ion_int_multiply_by_digit(II_DIGIT *digits, ION_SIZE digit_count, II_DIGIT value);
*/
iERR  _ion_int_multiply_and_add(II_DIGIT *digits, ION_SIZE digit_count, II_DIGIT mult_value, II_DIGIT add_value);
iERR  _ion_int_divide_by_digit(II_DIGIT *digits, ION_SIZE digit_count, II_DIGIT  value, II_DIGIT *p_remainder);
